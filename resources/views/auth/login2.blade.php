        ...
        <div class="w-3/4 mx-auto  py-10">
            <div class="w-3/4  mx-auto">
                ...
                <div class="flex flex-col items-center py-5">
                    <h1 class="text-4xl text-white font-bold" style="font-family: 'Manrope', sans-serif;">Log in to your
                    </h1>
                    <h1 class="text-4xl text-white font-bold mt-2" style="font-family: 'Manrope', sans-serif;"><span
                            class="text-red-600">Recipeat</span> account
                    </h1>
                    ...
                    <form class="py-10" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="py-2 mt-8" x-data="{ show: true }">
                            ...
                            <div class="relative">
                                <input id="password" name="password" placeholder="Password *"
                                    ...
                                    class="form-control bg-white  px-3 py-2 border-black text-gray-800 w-96 h-12 rounded-md @error('password') is-invalid @enderror"
                                    style="font-family: 'Manrope', sans-serif;">
                        ...
                        <div class="flex justify-between py-8">
                            ...
                            <a href="{{ route('login.google') }}"
                                class="text-white flex items-center  border rounded-md px-6 py-2"><img
