...
<body class="antialiased overflow-x-hidden">
    <section class="" style="background: rgba(21, 17, 17, 1);">
        ...
        <h1 class="text-center py-6 text-white text-4xl font-bold" style="font-family: 'Manrope', sans-serif;">Welcome to Recip<span
                class="text-red-600">eat!</span></h1>
        <div class="w-1/2 mx-auto  py-10">
            <div class="flex justify-between w-full mx-auto ">
                ...
                <div class="flex items-center justify-end space-x-4 mb-4">
                    <i class="fas fa-chevron-circle-left text-white text-2xl"></i>
            ...
            <h1 class="text-white py-4 text-lg text-center" style="font-family: 'Manrope', sans-serif;">We would like to improve your cooking experience. This will
                take less than a minute</h1>
            <div class="w-1/2 mx-auto py-5" style="font-family: 'Manrope', sans-serif;">
                <input type="text" placeholder="What’s your name?"
                    class="text-4xl text-center form-control border-b border-gray-400 bg-transparent w-full flex justify-center py-6 placeholder:text-gray-400">
            </div>
            <div class="w-full flex items-center justify-end py-10">
                <a href="" class="bg-red-600 text-white w-36 py-2 flex justify-center item-center rounded-md">Next
