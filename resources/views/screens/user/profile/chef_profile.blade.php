...
@section('content')
    <div class="py-2 mx-12  mt-4 flex justify-evenly items-start space-x-6">
        <div class="w-1/4 py-10 text-white rounded-lg px-8" style="background:#141414">
        ...
        <div class="w-3/4 py-2 top-0">
            ...
            <div class="flex py-2 mx-6 -mt-32 space-x-6">
                <div class="flex py-4 w-4/12 rounded-lg px-2" style="background:#141414">
                    ...
                    <div class="flex flex-col justify-end items-center space-y-4 w-full mb-2 ">
                ...
                <div class="flex items-end py-5 w-8/12">
                    <div class="flex px-2 py-4 space-x-4 rounded-lg  w-full" style="background:#141414">
                        <div class="w-1/4 flex py-4 items-center rounded-lg" style="background: #252525;">
                            <div
                                class="border-l-2 py-2 border-red-500 flex items-center justify-start space-x-4 px-1 w-full">
                                <svg class="w-8 h-8" width="21" height="21" viewBox="0 0 21 21" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="w-1/4 flex py-4 items-center rounded-lg" style="background: #252525;">
                            <div
                                class="border-l-2 py-2 border-red-500 flex items-center justify-start space-x-4 px-1 w-full">
                                <svg class="w-8 h-8" width="21" height="23" viewBox="0 0 21 23" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
