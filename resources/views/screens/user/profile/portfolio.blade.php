                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-10">
                                    ...
                                    <div class="mr-3">
                                        <!--begin::Name-->
                                        <a href="#"
                                            class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">{{ $chef_questions->name }}</a>
                                        <!--end::Name-->
                                        <br />
                                        <!--begin::Contacts-->
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header h-auto border-0">
                                <div class="card-title py-5">
                                    <h3 class="card-label">
                                        <span class="d-block text-dark font-weight-bolder">Personal Information</span>
                                    ...
                                    <div class="d-flex align-items-center mb-9 bg-light-danger rounded p-5">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1 mr-2">
                                            <p href="#"
                                                ...
                                                Location</p>
                                            <span class="text-muted font-weight-bold">{{ $chef_questions->location }},
                                                {{ $chef_questions->state }}</span>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="d-flex align-items-center bg-light-success rounded p-5 mb-9">
                                        ...
                                        <span class="svg-icon svg-icon-success mr-5">
                                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-04-21-040700/theme/demo1/dist/../src/media/svg/icons/Clothes/Tie.svg--><svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                    viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1 mr-2">
                                            <p href="#"
                                                class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">
                                                Designation</p>
                                            <span class="text-muted font-weight-bold">{{ $chef_questions->designation }},
                                                {{ $chef_questions->company }}</span>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Item-->
                                ...
                                <div id="kt_charts_widget_4_chart">
                                    ...
                                    <div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
                                        <span class="svg-icon svg-icon-warning svg-icon-2x mr-5">
                                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-04-21-040700/theme/demo1/dist/../src/media/svg/icons/Cooking/KnifeAndFork2.svg--><svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                    viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <div class="d-flex align-items-center bg-light-info rounded p-5 mb-9">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1 mr-2">
                                            <p href="#"
                                                ...
                                                Accomplishments</p>
                                            <span
                                                class="text-muted font-weight-bold">{{ $chef_questions->accomplishments }}</span>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Item-->
