        ...
        <div class="row w-100 h-100">
            ...
            <div class="col-md-4 mt-2 bg-secondary rounded">
                <h3 class="mt-4 p-2">PINBOARD</h3>
                 {{-- <div class="container mt-4 bg-success mb-4 d-flex justify-content-center p-2 h-full">
                    <a href="/follower" class="d-flex justify-content-center align-items-center" data-toggle="tooltip"
                        title="" data-original-title="More">
                        <i class="text-dark fas fa-plus-circle fa-1x mr-1"></i> My Favourite
                    </a>
                </div>
                <div class="container mt-4 bg-success mb-4 d-flex justify-content-center p-2 h-full">
                    My Favourite Dinner
                    ...
                    <div class=" bg-secondary h-100 w-100 rounded m-4 p-3">
                        <div class="w-100 pb-6">
                            <div class="accordion" id="accordionExample">
                                <div class="car
                                d w-100">
                                    <div class="card-head rounded p-3 bg-success" id="headingOne">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                        ...
                                        <div class="card-body rounded">
                                            {{-- <div class=" d-flex flex-wrap row w-100 p-2">
                                                <ul class="list-style-none w-100 list-icons d-flex flex-column flex-wrap flex-item text-center pt-2">
                                ...
                                <div class="card w-100">
                                    <div class="card-head rounded p-3 bg-light-info" id="headingTwo">
                                ...
                                <div class="card w-100">
                                    <div class="card-head rounded p-3 bg-light-warning" id="headingTwo">
                                        <h2 class="mb-0 p-2 collapsed d-flex justify-content-center align-items-center"
                                            data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false"
                                            aria-controls="collapseTwo">
                                            My Favourite Deserts
                                        </h2>
                                    </div>
                                    {{-- <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" --}}
                                        {{-- data-parent="#accordionExample"> --}}
                                                ...
                                                <ul
                                                    ...
                                                    {{-- <li class="col px-2 p-1 d-flex justify-content-center ">
                                                        <a href="/follower"
                                                            class="d-flex justify-content-center align-items-center"
                                                            data-toggle="tooltip" title="" data-original-title="More">
                                                            <i class="text-dark fas fa-plus-circle fa-1x mr-1"></i>Chicken-curry
                                                        </a>
                                                    </li>
                                                </ul> --}}
                                ...
                                <div class="card w-100">
                                    <div class="card-head rounded p-3 bg-light-danger" id="headingTwo">
                                        <h2 class="mb-0 p-2 collapsed d-flex justify-content-center align-items-center"
                                            data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false"
                                            aria-controls="collapseTwo">
                                            My Favourite Dinner
                                            ...
                                            {{-- <div class=" d-flex flex-wrap row w-100 p-2">
                                                <ul
                                                    ...
                                                    @foreach ($recipe as $recipes)
                                                        <li class="w-100 d-flex w-75  p-1">
                                                            <a class="d-flex flex-row w-50 justify-content-center " href="\recipes"
                                                                data-toggle="tooltip" title=""
                                                                data-original-title="Shaina Chhatraliya">

                                                                <span
                                                                    class="p-2 ml-5  d-flex align-items-center">{{ $recipes->recipe_name }}</span>
