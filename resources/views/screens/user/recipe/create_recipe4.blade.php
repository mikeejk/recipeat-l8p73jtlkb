...
<body class="antialiased bg-black ">
    ...
    <main class="mx-auto w-7/12  py-10 mt-10 justify-center item-center">
        <div class="flex flex-col">
            <p class="text-lg text-gray-100 ">Last Step</p>
            <div class="h-0.5 mt-4 w-11/12 bg-gray-500 rounded-full">
                <div class="w-full h-0.5 bg-white"></div>
                <h1 class="text-white py-4">Extra Details</h1>
            </div>
        </div>
        <div class="mx-auto w-1/2 py-10 flex flex-col  justify-center item-center">
            <label for="" class="text-white">Specify Tags for your recipe</label>
            <select class="form-control select2 select-tags rounded-lg mt-5 py-5 bg-gray-500">
        ...
        <div class="mx-auto w-1/2 py-5 flex flex-col  justify-center item-center">
            <select class=" rounded-lg text-white py-5 bg-gray-500">
                <option class="text-gray-200">Select Specific Diet,If any</option>
                {{-- <option>summer</option> --}}
            </select>
        </div>
        <div class="mx-auto w-1/2 py-5 flex flex-col  justify-center item-center">
            <label for="" class="text-white">General Taste Profile of the recipe</label>
            <div class="flex space-x-6 mt-5 space-x-5 text-white">

                <input class="hidden" id="1000" name="" value=""type="" checked />
                <label class="flex justify-center items-center border rounded-md p-2 " for="1000">
                    <span class='hidden icon bg-white'>
                        <i class="fas fa-check border border-gray-600 bg-white text-black rounded-full text-xs font-semibold p-1 mr-2 "></i></span>

                    <span class="text-uzs text-base font-Rubik font-semibold">Sweet</span>
                </label>
                <input class="hidden" id="5000" name="" value="" type="radio" />
                <label class="flex justify-center items-center   border rounded-md p-2 " for="5000">
                    ...
                    <span class="text-uzs text-base font-Rubik font-semibold">Spicy</span>
                </label>

                <input class="hidden" id="4000" name="" value=""type="radio" />
                <label class="flex justify-center items-center px-2  border rounded-md p-2 " for="4000">
                    <span class='hidden icon bg-white'><i
                            class="fas fa-check border border-gray-600 bg-white text-black rounded-full text-xs font-semibold p-1 mr-2"></i></span>
                    <span class="text-uzs text-base font-Rubik font-semibold">Sour</span>
                </label>
            </div>
        </div>
