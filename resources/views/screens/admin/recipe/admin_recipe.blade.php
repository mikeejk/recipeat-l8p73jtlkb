                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        ...
                        <div class="d-flex align-items-baseline flex-wrap">
                            <div class="card-toolbar">
                                ...
                                <!--begin::Button-->
                                <a href="/addCategory" style="margin-bottom: 2px;" class="btn btn-primary font-weight-bolder">
                                ...
                                <!--begin::Button-->
                                <a href="/addCuisine" style="margin-bottom: 2px;" class="btn btn-primary font-weight-bolder">
                                    <span class="svg-icon svg-icon-md">
                                        <span class="svg-icon svg-icon-white">
                                ...
                                " style="margin-bottom: 2px;" class="btn btn-primary font-weight-bolder">
                                    <span class="svg-icon svg-icon-md">
                                        <span class="svg-icon svg-icon-white">
                                ...
                                <!--begin::Button-->
                                <a href="/measurements_create" style="margin-bottom: 2px;" class="btn btn-primary font-weight-bolder">
                                    <span class="svg-icon svg-icon-md">
                                        <span class="svg-icon svg-icon-white">
