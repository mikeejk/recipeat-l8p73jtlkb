                            ...
                            <div class="d-flex  w-100 align-items-baseline flex-wrap">
                                <div class="card-toolbar w-100">
                                    ...
                                    <a href="/categorys_create" style="margin-bottom: 2px;"
                                        class="btn btn-outline-primary col-lg-2 col-md-3 col-12 text-wrap font-weight-bolder">
                                    ...
                                    <a href="/ingredients_create" style="margin-bottom: 2px;"
                                        class="btn btn-primary col-lg-2 col-md-3 col-12 text-wrap font-weight-bolder">
                                        <span class="svg-icon svg-icon-md">
                                            <span class="svg-icon svg-icon-white">
                                    ...
                                    <a href="/measurements_create" style="margin-bottom: 2px;"
                                        class="btn btn-outline-primary col-lg-3 col-md-3 col-12 text-wrap font-weight-bolder">
                                        <span class="svg-icon svg-icon-md">
                                            <span class="svg-icon svg-icon-white">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('ingredient') is-invalid @enderror"
                                    placeholder="New Ingredient" name="ingredient"
