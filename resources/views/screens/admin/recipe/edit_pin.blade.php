...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <!--end::Notice-->
            <!--begin::Card-->
<form class="form" action="/pins/{{ $pin->id }}" method="post">
    @method('PATCH')
        ...
        <div class="col-md-6 col-12">
            <div class="input-group">
                ...
                <input type="text" class="form-control  @error('pin_name') is-invalid @enderror"
                    placeholder="Edit Pin_name" name="pin_name" value="{{ $pin->pin_name }}" />
            </div>
        </div>
        <div class="col-lg-2 col-md-2 col-5 mt-1">
            <button type="submit" name="action" value="pin_name_save"
