        ...
        <div class="container">
            ...
            <form class="form" action="/ingredients" method="post">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-lg-10">
                            <a href="/admin_recipe"><button type="button" class="btn btn-secondary mr-2">Get Back</button></a>
                        </div>
                        <div class="col-lg-2">
                            <button type="submit" class="btn btn-primary">Save and Insert Next</button>
                        </div>
                    </div>
                </div>
            </form>
